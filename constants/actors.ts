...
export const FEATURED_ACTORS: Actor[] = [
  {
    id: 1,
    ...
    shortDesc:
      "A multi-Academy Award winning titan of modern cinema, renowned for iconic performances in 'Training Day', 'Fences', and 'Gladiator II'.",
    bio: [
  ...
  },
  {
    ...
    label: "Featured Talent",
    shortDesc:
      "Academy Award-winning actress celebrated for versatile cinematic roles ranging from 'Girl, Interrupted' to 'Maleficent' and 'Maria'.",
    bio: [
  ...
  },
  {
    ...
    label: "Featured Talent",
    shortDesc:
      "Beloved worldwide for legendary roles in 'Forrest Gump', 'Cast Away', 'Saving Private Ryan', and 'Apollo 13'.",
    bio: [
  ...
  },
  {
    ...
    label: "Featured Talent",
    shortDesc:
      "Emmy and Golden Globe winner celebrated for 'Friends', 'The Morning Show', and a successful roster of acclaimed feature films.",
    bio: [
  ...
  },
  {
    ...
    label: "Featured Talent",
    shortDesc:
      "Cinematic icon famed for 'The Godfather' trilogy, 'Scarface', 'Heat', and 'Scent of a Woman'. Triple Crown of Acting recipient.",
    bio: [
  ...
  },
  {
    ...
    label: "Featured Talent",
    shortDesc:
      "Academy Award winner for 'Oppenheimer' and world-renowned as Thomas Shelby in the global cultural sensation 'Peaky Blinders'.",
    bio: [
  ...
  },
  {
    ...
    label: "Featured Talent",
    shortDesc:
      "Two-time Emmy Award winner recognized for leading roles in 'Dune: Part One & Two', 'Euphoria', 'Challengers', and 'Spider-Man'.",
    bio: [
  ...
  },
  {
    ...
    label: "Featured Talent",
    shortDesc:
      "Academy Award winner celebrated for masterpieces including 'Inception', 'Titanic', 'The Wolf of Wall Street', and 'The Revenant'.",
    bio: [
